          ...
          }
          {
            Object.values(lastByUser).map((msg, index) => (
              ...
              <a key={index} href={"/chat?user=" + msg.participantes.filter(part => part !== localStorage.getItem("email"))}
                ...
                <img className="contact-avatar" src={user[msg.participantes.find(part => part !== localStorage.getItem("email"))]?.url || "/favicon.png"} width="50" height="50" style={{ objectFit: "cover" }} />
