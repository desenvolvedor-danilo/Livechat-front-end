...
import ErudaInit from "../debug/eruda";
import { hidedOrShowed } from "../componentes/functions/hidedOrShowed";
import { useRef } from "react";
import { ChooseElementType } from "../componentes/functions/ChooseElementType";
    ...
    <>
      ...
      <div className="chat-container">
        ...
        <div className="chat-input">
          ...
          <h1 role="button" className="absolute" id="hiddenInput" onClick={() => open.current.click()}>+</h1>
